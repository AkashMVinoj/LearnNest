...
class CourseVideoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_minutes', 'order', 'created_at'
        ]
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'submission', 'feedback', 'grade', 'created_at',
            'mentor', 'student', 'video', 'mentor_name', 'student_name', 'video_title'
        ]
...
class ExamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'course', 'course_title', 'title', 'description',
            'duration_minutes', 'total_marks', 'due_date', 'created_at',
            'is_published',
            'questions', 'submission_count'
        ]
        extra_kwargs = {
            'title': {'required': True},
